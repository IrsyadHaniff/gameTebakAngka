...
const backgroundMusicSuccess = document.getElementById("audioSuccess");
...
function playBackgroundMusic() {
  // cek browser support lagu/ tidak
...
function updateScore() {
  ...
  localTotalVictoryField.innerText = localStorage.getItem(localTotalVictoryKey);
  // play lagu kedua pada saat benar jawabannya
  playSuccessAudio();
}
function stopBackgroundMusic() {
  // cek browser support lagu/ tidak
  if (backgroundMusic && typeof backgroundMusic.pause === "function") {
    // Pause pause lagu pertama
    backgroundMusic.pause();
  }
}
function playSuccessAudio() {
  // cek browser support lagu/ tidak
  if (backgroundMusicSuccess && typeof backgroundMusicSuccess.play === "function") {
    //muai lagu kedua jika eror muncul console log
    backgroundMusicSuccess.play().catch((error) => {
